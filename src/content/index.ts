...
const PLATFORM_ADAPTERS: PlatformAdapter[] = [
  ...
  },
  {
    ...
    contentSelectors: [".markdown", "[class*='markdown']", "[class*='font-claude-message']", "[class*='message']", "[class*='content']"],
  ...
  },
  {
    ...
    contentSelectors: [".prose", ".markdown", "[class*='prose']", "[class*='markdown']", "[class*='answer']", "[class*='content']"],
  ...
  },
  {
    ...
    contentSelectors: [".markdown", "[class*='markdown']", "[class*='Message']", "[class*='message']", "[class*='content']"],
